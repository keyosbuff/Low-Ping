...
:: 
:: Credits:
:: Original Author: keyoszn
:: Based on various sources including:
:: - Network optimization techniques from [Resource or Website]
:: - TCP/IP Tweaks: [Link to source or tutorial]
:: - PowerShell commands: [PowerShell Script Reference]
:: 
:: ============================================
